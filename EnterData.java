...
//	the above seems wrong? is this another copy of invokeDataEntry in a different place? or are they the same being shared
...
//		was recommended to make a new instance of EnterData to fix the static issue
		dataCheck();
		//don't need to instantatite, define logic
	...
	if(answerdataCheck.charAt(0) == 'Y' || answerdataCheck.charAt(0) == 'y') {
		...
		} else if(answerdataCheck.charAt(0) == ('N' | 'n')) {
